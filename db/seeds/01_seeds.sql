...
INSERT INTO menu_items (item_name, item_price_cents, description, image)
VALUES ('Bluebery Danish', 275, 'Pastry filled with blueberry jam', '/images/Danishes-Blueberyy.jpg'),
('Cherry Danish', 275, 'Flaky pastry filled with cherry jam', '/images/Danishes-Cherry-Cheese.jpg'),
('Plain Croissant', 250, 'Flaky, buttery croissant', '/images/Croissant-Plain.jpg'),
('Custard Tart', 275, 'Fresh custard tart', '/images/custard.jpg'),
('Sicilian', 399, 'Ricotta chocolate chip filling in a fried cannoli shell, topped with candied cherries', '/images/Cannoli-Sicilian.jpg'),
('Rum Baba', 399, 'Soft baked pastry sponge soaked in a boiled rum mixture filled with custard and topped with candied cherries', '/images/Rum-Baba.jpg'),
('Whip Cream Eclair', 399, 'Baked eclair shell dipped in chocolate filled with whip cream', '/images/Lrg-Pastries-Whip-Cream-Eclair.jpg'),
('Chocolate Cupcake', 375, 'Chocolate or vanilla cupcake topped with chocolate buttercream.', 'images/Cupcake-Chocolate.jpg'),
('Chocolate Chip Brownies', 350, 'Chocolate brownie, topped with chocolate fudge and chocolate chips', '/images/Brownies-Chocolate-Chip.jpg'),
('Tiramisu', 449, 'Ladyfingers soaked in espresso and Khaula, layered with mascarpone filling and chocolate shavings', '/images/Other-Tiramisu-Cup.jpg');
